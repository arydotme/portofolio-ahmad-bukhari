    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8 font-lato dark:text-white">
      ...
      <div class="rounded-[24px] h-95 flex flex-col justify-between shadow-2xl border-2 border-claret dark:border-smoke">
        <div class="flow-root p-4">
          <img src="/src/assets/KneeOA.png" class="w-full h-45 rounded-[14px]" />
        </div>
        <div>
          <header class="pl-4 pb-2">
            <h1 class="font-extrabold font-lato text-[24px]">Knee Osteoarthritis</h1>
          </header>
          <header class="px-4">
            <p class="font-lato text-[14px]">Knee OA classification based on Kallgren & Laurance method</p>
          </header>
        </div>
      ...
      <div class="rounded-[24px] h-95 flex flex-col justify-between shadow-2xl border-2 border-claret dark:border-smoke">
        <div class="flow-root p-4">
          <img src="/src/assets/NirwanaWood.png" class="w-full h-45 rounded-[14px]" />
        </div>
        <div>
          <header class="pl-4 pb-2">
            <h1 class="font-extrabold font-lato text-[24px]">Nirwana Wood</h1>
          </header>
          <header class="px-4">
            <p class="font-lato text-[14px]">E-Commerce for UMKM raw wood in Blitar, East Java, Indonesia</p>
          </header>
        </div>
        <div class="flex flex-wrap pl-4">
      ...
      <div class="rounded-[24px] h-95 flex flex-col justify-between shadow-2xl border-2 border-claret dark:border-smoke">
        <div class="flow-root p-4">
          <img src="/src/assets/ChatBot.png" class="w-full h-45 rounded-[14px]" />
        </div>
        <div>
          <header class="pl-4 pb-2">
            <h1 class="font-extrabold font-lato text-[24px]">FAQ Campus</h1>
          </header>
          <header class="px-4">
            <p class="font-lato text-[14px]">Questions and Answers about academic activities at the university</p>
          </header>
        </div>
        <div class="flex flex-wrap pl-4">
          <span class="bg-dark-purple-2 hover:bg-claret font-lato px-3 py-1 mr-3 mb-2 rounded-full text-[10px] text-smoke tracking-widest">Personal Project</span>
